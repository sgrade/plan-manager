...
Currently, the most convenient way is to run Plan Manager in devcontainer on the same laptop/desktop computer where you have IDE/agents. Use web interface of [MCP Inspector](dev/mcp-inspector/README.md) as the main GUI and the read-only `/ui` page for supervision.
...
- **Read-only supervision UI:** `http://localhost:3000/ui`
